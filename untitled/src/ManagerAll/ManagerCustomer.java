...
import ValidatorAndReadFile.NameCustomerComparato;
import ValidatorAndReadFile.ReadAndWriteFile;
import ValidatorAndReadFile.ValidateCustomer;

import java.util.*;

public class ManagerCustomer {
    ValidateCustomer validateCustomer = new ValidateCustomer();
    ReadAndWriteFile<Customer> writeReadFile = new ReadAndWriteFile<>();
    ...
    public Customer selectCustomerFromFile() throws InterruptedException {
        ...
        Map<String, String> map = writeReadFile.readBookingCsv();
    ...
    public void deleteCustomer() throws InterruptedException {
        ...
        do {
            ...
            if (confirmDel.equals("Yes")) {
                ...
                if (confirmDel.equals("No")) {
                    return;
                }else {
                    System.err.println("Nhập Yes hoặc No!");
                    Thread.sleep(250);
                }
            }
        }while (true);
